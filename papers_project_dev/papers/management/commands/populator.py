...
discipline = ['table recognition']
max_results = 1000
output_file = '/Users/ewan.mayhew/Jaid/papers_project_dev/papers/data/table_recognition_dataset.json'
main(discipline, max_results, output_file)
